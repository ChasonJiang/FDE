...
from evaluation_mouth import Evaluator
...
class Trainer(object):
    ...
    def initConfig(self):
        ...
        self.batch_size = 8 
        # int. Number of feature vector dimensions of mouth
        # self.num_dim = 59 -18
        self.num_dim = 7
        self.hidden_dim = 128
        ...
        self.model_save_path = "./checkpoints/FDE_mouth"
        # int. Frequency of model saving
        self.save_freq = 1
        # string. Saving path of tensorboard log
        self.tb_log_save_path = "./tb_log/mouth/"
    ...
    def train(self,):
        ...
        for i in range(self.num_epoch):
            for idx, data in enumerate(self.dataLoader):
                ...
                labels:torch.Tensor = data["label"][:, -12:-5]
