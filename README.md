# Facial Data Extraction Based on Fusion of Residual Features and Keypoint Features（FDEv2）
...
<!-- - Firstly, you need to clone this project using the following command:
	- git clone https://github.com/ChasonJiang/FDE.git
...
- ### Train
	- Step 1, Download the dataset into project root dir.
    	- dataset [donwload link](https://pan.baidu.com/s/1TsKqckYxXDcM08NC1aDJSA) code：4wct
	- Step 2, Run train.py
