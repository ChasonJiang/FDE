...
class Extractor(object):
    ...
    def initConfig(self):
        ...
        self.model_load_path = "checkpoints/FDE_all/epoch 12.pth"
    ...
    def extract(self,filename:str,savepath:str):
        ...
        # v=np.zeros(self.num_dim,dtype=np.float32)
        # v[:19]=output[:19]
        # v[32:] = output[19:]
        # output=v
...
if __name__ =="__main__":
    ...
    data=extractor.extract(filename="test/xiaowu_face.png",savepath="test/xiaowu_face.json")
